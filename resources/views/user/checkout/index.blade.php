            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_pengiriman" required rows="3" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" placeholder="Jalan, No. Rumah, Kelurahan, Kecamatan, Kota...">{{ old('alamat_pengiriman', auth()->user()->alamat) }}</textarea>
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="jarak_km" required min="1" max="100" step="0.1" x-model="jarak" value="{{ old('jarak_km', 1) }}" class="w-full px-4 py-2.5 pr-16 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm">
...
<script>
    function checkoutForm() {
        return {
            ...
            get ongkir() { return (parseFloat(this.jarak) || 0) * this.ongkirPerKm; },
